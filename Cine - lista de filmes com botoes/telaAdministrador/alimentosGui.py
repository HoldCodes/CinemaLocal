...
class alimentosGui():
    ...
    """PENSEI EM CRIAR UMA CLASSE PRA ESSES BOTÕES, MAS NÃO SEI SE FAZ SENTIDO, JÁ QUE NENHUMA FUNÇÃO VAI SERVIR PRAS OUTRAS INTERFACES"""
    ...
    def insertButton(self):
        ...
        self.cursor.execute(
            ...
            (self.nome, self.preco, self.categoria))
        self.conn.commit()
        self.desconecta_bd()
        self.selectButton()
    ...
    def selectButton(self):
        ...
        lista = self.cursor.execute(
            """ SELECT cod, nome_alimento, preco_alimento, categoria_alimento FROM alimentos ORDER BY nome_alimento ASC;""")
