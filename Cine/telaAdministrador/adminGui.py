...
class adminGui():
    ...
    def framesAdmin(self):
        ...
        btn_admin = Button(self.frame_left_btn, text='Adicionar administrador',command=lambda: self.frame_content.destroy())
        btn_admin.place(relx=0, rely=0.15, relwidth=1, relheight=0.15)

        btn_film = Button(self.frame_left_btn, text='Gerenciar filmes')
